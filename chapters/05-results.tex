...
File ELF có sẵn trong bản mã nguồn hoàn chỉnh được đo bằng \code{arm-none-eabi-size}:

\begin{table}[H]
  \centering
  \caption{Kích thước firmware trong file ELF hoàn chỉnh}
  \label{tab:elf-size}
  \begin{tabular}{rrrrr}
    \toprule
...
Số liệu trên phản ánh file ELF trong thư mục \code{Debug} của project hoàn chỉnh. Nó cho biết kích thước tĩnh, không thay thế phép đo stack đỉnh, tải CPU, FPS hoặc jitter trên board.
\end{reportnote}
